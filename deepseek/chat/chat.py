...
def append_to(current_type: str, val: str, response_text: str, thinking_text: str):
    ...
    for line in send_message_stream(
        ...
        if "p" not in chunk and "v" in chunk:
            if isinstance(val, str):
                response_text, thinking_text = append_to(current_type, val, response_text, thinking_text)
                ...
                for frag in response_obj.get("fragments", []):
                    ...
                    response_text, thinking_text = append_to(current_type, content, response_text, thinking_text)
            continue
